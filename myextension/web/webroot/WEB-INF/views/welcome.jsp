...
<div class="container">
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/myextension-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/myextension-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/myextension-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/myextension-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/myextension-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
