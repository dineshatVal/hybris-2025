 ...
 */
package com.sample.module.core.constants;

/**
 * Global class for all SamplemoduleCore constants. You can add global constants for your extension into this class.
 */
public final class SamplemoduleCoreConstants extends GeneratedSamplemoduleCoreConstants
{
	public static final String EXTENSIONNAME = "samplemodulecore";


	private SamplemoduleCoreConstants()
	{
		//empty
	}
