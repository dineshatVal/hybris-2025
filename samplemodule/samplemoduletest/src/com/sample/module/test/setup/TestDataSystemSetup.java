 ...
 */
package com.sample.module.test.setup;
...
import com.sample.module.test.constants.SamplemoduleTestConstants;
import com.sample.module.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SamplemoduleTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/samplemoduletest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/samplemoduletest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/samplemoduletest/import/cstickets.impex");
			...
			importImpexFile(context, "/samplemoduletest/import/csquotes.impex");
		}
	}
}
