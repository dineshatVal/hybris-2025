 ...
 */
package com.custom.webservices.controllers;
...
import com.custom.webservices.data.UserDataList;
import com.custom.webservices.dto.SampleWsDTO;
import com.custom.webservices.dto.TestMapWsDTO;
import com.custom.webservices.dto.UserWsDTO;
import com.custom.webservices.dto.UsersListWsDTO;
import com.custom.webservices.dto.UsersPageWsDTO;
import com.custom.webservices.facades.SampleFacades;
...
import static com.custom.webservices.constants.MycustomwebservicesConstants.SAMPLE_LIST_DOUBLE_VALUE;
import static com.custom.webservices.constants.MycustomwebservicesConstants.SAMPLE_LIST_STRING_VALUE;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/mycustomwebservices/sample/dto/sampleValue
	 *
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/mycustomwebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/mycustomwebservices/sample/users
	 * <li>http://localhost:9001/mycustomwebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/mycustomwebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/mycustomwebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/mycustomwebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/mycustomwebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/mycustomwebservices/sample/usersPaged
	 * <li>http://localhost:9001/mycustomwebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/mycustomwebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/mycustomwebservices/sample/users/user1
	 * <li>http://localhost:9001/mycustomwebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/mycustomwebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/mycustomwebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/mycustomwebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/mycustomwebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 * <p>
	 * Url: http://localhost:9001/mycustomwebservices/sample/map
	 */
