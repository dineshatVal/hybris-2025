 ...
 */
package com.custom.webservices.constants;

/**
 * Global class for all Mycustomwebservices constants. You can add global constants for your extension into this class.
 */
public final class MycustomwebservicesConstants extends GeneratedMycustomwebservicesConstants
{
	public static final String EXTENSIONNAME = "mycustomwebservices";
	...
	public static final String HOST = "mycustomwebservices.host";
	public static final String HOST_DEFAULT = "hostname";

	private MycustomwebservicesConstants()
	{
