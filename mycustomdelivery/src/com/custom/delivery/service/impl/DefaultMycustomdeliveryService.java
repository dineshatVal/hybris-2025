 ...
 */
package com.custom.delivery.service.impl;
...
public class DefaultMycustomdeliveryService implements MycustomdeliveryService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMycustomdeliveryService.class);
	...
	{
		return DefaultMycustomdeliveryService.class.getResourceAsStream("/mycustomdelivery/sap-hybris-platform.png");
	}
