 ...
 */
package com.customer.feebback.service.impl;
...
public class DefaultMycustomerreviewService implements MycustomerreviewService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMycustomerreviewService.class);
	...
	{
		return DefaultMycustomerreviewService.class.getResourceAsStream("/mycustomerreview/sap-hybris-platform.png");
	}
